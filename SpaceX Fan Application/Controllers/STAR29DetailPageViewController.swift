//
//  STAR29DetailPageViewController.swift
...
class STAR29DetailPageViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        func fetchRocket(){
            let urlString = "\(launchURL)60b3b843998a020e76e3284b"
