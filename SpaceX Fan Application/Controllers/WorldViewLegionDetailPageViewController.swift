//
//  WorldViewLegionDetailPageViewController.swift
...
import UIKit
struct  WorldViewLegionData : Codable  {
        let name : String
...
class WorldViewLegionDetailPageViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        func fetchRocket(){
            let urlString = "\(launchURL)607a35b55a906a44023e0864"
