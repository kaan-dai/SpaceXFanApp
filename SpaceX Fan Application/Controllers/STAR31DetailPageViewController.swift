//
//  STAR31DetailPageViewController.swift
...
class STAR31DetailPageViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        func fetchRocket(){
            let urlString = "\(launchURL)61058c4db99c4529bfb0c0b9"
