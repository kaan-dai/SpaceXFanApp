//
//  DARTDetailPageViewController.swift
...
class DARTDetailPageViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        func fetchRocket(){
            let urlString = "\(launchURL)5fe3b107b3467846b324216b"
