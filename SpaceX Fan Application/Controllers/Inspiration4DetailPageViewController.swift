//
//  Inspiration4DetailPageViewController.swift
...
import UIKit
struct  Insperation4Data : Codable  {
        let name : String
...
class Inspiration4DetailPageViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        func fetchRocket(){
            let urlString = "\(launchURL)607a37565a906a44023e0866"
