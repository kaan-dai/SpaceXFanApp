//
//  RocketDetailPageViewController.swift
//  SpaceX Fan Application
//
//  Created by Kaan Dai on 23.08.2021.
//

import UIKit
//import SwiftUI
//struct ContentView: View {
//    private var numImages = 4
//    var body: some View{
//        GeometryReader{ proxy in
//            TabView{
//                ForEach(0..<numImages){ num in
//                    Image("\(num)").resizable().tag(num)
//
//                }
//            }.tabViewStyle(PageTabViewStyle()).clipShape(RoundedRectangle(cornerRadius: 5)).padding().frame(width: proxy.size.width, height: proxy.size.height/3)
//
//    }
//    }
//}

class Falcon9DetailPageViewController: UIViewController {
    ...
    @IBAction func favoriteButton(_ sender: UIBarButtonItem) {
        NotificationCenter.default.post(name: Notification.Name("myBtnTapped1"), object: nil)
        buttonTappedCount += 1
    ...
    override func viewDidLoad() {
        ...
        func fetchRocket(){
            let urlString = "\(rocketURL)5e9d0d95eda69973a809d1ec"
