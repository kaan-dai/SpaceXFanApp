//
//  NROL85DetailPageViewController.swift
...
class NROL85DetailPageViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        func fetchRocket(){
            let urlString = "\(launchURL)608d3d23ffcee803616cbde2"
