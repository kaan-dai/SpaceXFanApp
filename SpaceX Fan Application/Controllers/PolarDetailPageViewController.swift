//
//  PolarDetailPageViewController.swift
...
class PolarDetailPageViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        func fetchRocket(){
            let urlString = "\(launchURL)60e3bf0d73359e1e20335c37"
