//
//  FalconHeavyDetailPageViewController.swift
...
class FalconHeavyDetailPageViewController: UIViewController {
    ...
    @IBAction func favoriteButton(_ sender: UIBarButtonItem) {
        NotificationCenter.default.post(name: Notification.Name("myBtnTapped3"), object: nil)
        buttonTappedCount += 1
    ...
    override func viewDidLoad() {
        ...
        func fetchRocket(){
            let urlString = "\(rocketURL)5e9d0d95eda69974db09d1ed"
